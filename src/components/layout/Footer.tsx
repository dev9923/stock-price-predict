...
const Footer = () => {
    return (
        <footer className="bg-gray-900 border-t border-gray-800 dark:bg-black dark:border-gray-900 text-white">
                ...
                <div className="border-t border-gray-800 mt-12 pt-8">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-800 text-center">
                        <p className="text-xs text-gray-500">
                            <strong>Risk Disclaimer:</strong> Trading in stocks involves risk. AI predictions are for informational purposes only.
                        </p>
                    </div>
                </div>
            </div>
