      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Algorithm Comparison</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {algorithms.map((algorithm, index) => (
              ...
              >
                <div className={`absolute top-0 right-0 w-20 h-20 ${colorMap[algorithm.color].bg} rounded-full -mr-10 -mt-10`} />
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-bold text-gray-900">{algorithm.name}</h3>
                    <span className={`text-2xl font-bold ${colorMap[algorithm.color].text}`}>{algorithm.accuracy}</span>
                  </div>
                  <p className="text-gray-600 mb-4">{algorithm.description}</p>
                  <ul className="space-y-2">
                    {algorithm.pros.map((pro, i) => (
                      <li key={i} className="flex items-center space-x-2">
                        <Zap className={`h-4 w-4 ${colorMap[algorithm.color].icon}`} />
      ...
      <section className="section-padding">
        <div className="container-max">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Performance Metrics</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
